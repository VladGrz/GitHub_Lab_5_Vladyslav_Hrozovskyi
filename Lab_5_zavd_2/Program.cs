...
namespace Lab_5_zavd_2
{
    public abstract class Conference
    {
        ...
        public abstract void AverageOfParticipants(Meeting[] m);
        public abstract void MaxParticipants(Meeting[] m);
    }
    public class Meeting : Conference
    {
        ...
        public override void AverageOfParticipants(Meeting[] m)
        {
            string n;
        ...
        public override void MaxParticipants(Meeting[] m)
        {
