...
namespace Lab_5_zavd_1
{
    ...
    public class Meeting : Conference
    {
        ...
        public static void LengthOfName(Meeting[] c)
        {
        ...
        public static void AverageOfParticipants(Meeting[] m)
        {
            string n;
        ...
        public virtual int MaxParticipants(Meeting[] m)
        {
            ...
            return m[imax].NumOfParticipants;
        }
    ...
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            userCheck:
                ...
                {
                    Meeting.AverageOfParticipants(meet);
                }
                else if(check == 'L')
                {
                    Meeting.LengthOfName(meet);
                }
                else if(check == 'M')
                {
